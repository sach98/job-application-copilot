...
- **skills_match** (0-1): candidate's real skills/tools vs the JD's core requirements
  (not every buzzword — what the role actually needs).
...
## Calibration (critical — an 80% gate depends on this)

- **0.80–1.00** → you would confidently shortlist this candidate; strong, realistic match
  on responsibilities AND skills AND level AND domain.
- **0.55–0.79** → decent/plausible but generic, or one dimension is soft.
- **0.30–0.54** → weak: wrong level, thin skill overlap, or adjacent-only domain.
- **< 0.30** → clear mismatch.
